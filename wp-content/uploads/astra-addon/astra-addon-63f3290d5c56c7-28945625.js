...
! function(n, h) {
    ...
    var e, i = jQuery("body"),
        o = i.width(),
        p = astraAddon.stick_header_meta || "default",
        y = astraAddon.header_main_stick || "",
        _ = astraAddon.header_main_shrink || "",
        m = astraAddon.header_above_stick || "",
        u = astraAddon.header_below_stick || "",
        k = astraAddon.header_main_stick_meta || "",
        b = astraAddon.header_above_stick_meta || "",
        g = astraAddon.header_below_stick_meta || "",
        v = astraAddon.site_layout || "",
        w = astraAddon.site_layout_box_width || 1200,
        j = astraAddon.sticky_header_on_devices || "desktop",
        Q = astraAddon.sticky_header_style || "none",
        f = astraAddon.sticky_hide_on_scroll || "",
        x = astraAddon.header_logo_width || "",
        C = astraAddon.responsive_header_logo_width || "",
        S = astraAddon.stick_origin_position || "",
        I = astraAddon.tablet_break_point || 768,
        A = astraAddon.mobile_break_point || 544;
    "disabled" != p && ("enabled" === p && (y = k, m = b, u = g), 0 < n("header .site-logo-img img").length && (-1 === (k = 0 == (k = void 0 === (k = (p = n("header .site-logo-img img")).attr("height")) ? p.height() : k) ? "" : k).toString().indexOf("%") && (k += "px"), "" != C.desktop || "" != C.tablet || "" != C.mobile ? e = "<style type='text/css' id='ast-site-identity-img' class='ast-site-identity-img' > #masthead .ast-header-sticked .site-logo-img .astra-logo-svg { width: " + C.desktop + "px; } @media (max-width: " + I + "px) { #masthead .ast-header-sticked .site-logo-img .astra-logo-svg { width: " + C.tablet + "px; } } @media (max-width: " + A + "px) { #masthead .ast-header-sticked .site-logo-img .astra-logo-svg{ width: " + C.mobile + "px; } } </style>" : "" != x && (e = "<style type='text/css' id='ast-site-identity-img' class='ast-site-identity-img' > #masthead .ast-header-sticked .site-logo-img .astra-logo-svg { width: " + x + "px; } #masthead .ast-header-sticked .site-logo-img img { max-height: " + k + "; width: auto; } </style>"), n("head").append(e)), (y || m || u) && (n(l).on("addStickyClass", function() {
        var e = "";
        "1" != y && "on" != y && "disabled" != y || (e += " ast-primary-sticky-header-active"), "1" != m && "on" != m && "disabled" != m || (e += " ast-above-sticky-header-active"), "1" != u && "on" != u && "disabled" != u || (e += " ast-below-sticky-header-active"), n("body").addClass(e)
    }), n(l).on("removeStickyClass", function() {
        var e = "";
        "1" != y && "on" != y && "disabled" != y || (e += " ast-primary-sticky-header-active"), "1" != m && "on" != m && "disabled" != m || (e += " ast-above-sticky-header-active"), "1" != u && "on" != u && "disabled" != u || (e += " ast-below-sticky-header-active"), n("body").removeClass(e)
    }), "ast-box-layout" === v && (o = parseInt(w)), jQuery(l).on("ready astLayoutWidthChanged", function(e) {
        if ("astLayoutWidthChanged" === e.type) {
            if (!(parseInt(y) || parseInt(u) || parseInt(m))) return;
            jQuery("div.ast-stick-primary-below-wrapper").children().unwrap(), jQuery('div[data-stick-support="on"]').children().unwrap()
        }
        var t;
        "1" == f ? ("1" == _ && jQuery("#ast-fixed-header").addClass("ast-sticky-shrunk").stop(), "1" != m && "on" != m && "disabled" != m && jQuery("#ast-fixed-header .ast-above-header").hide(), "1" != y && "on" != y && "disabled" != y && jQuery("#ast-fixed-header .main-header-bar").hide(), "1" != u && "on" != u && "disabled" != u && jQuery("#ast-fixed-header .ast-below-header").hide(), jQuery("#ast-fixed-header").astExtSticky({
            max_width: o,
            site_layout: v,
            sticky_on_device: j,
            header_style: "slide",
            ...
            header_style: Q,
            hide_on_scroll: f
        }))) : (jQuery("#ast-fixed-header").addClass("ast-sticky-shrunk").stop(), "1" != m && "on" != m && "disabled" != m && jQuery("#ast-fixed-header .ast-above-header").hide(), "1" != y && "on" != y && "disabled" != y && jQuery("#ast-fixed-header .main-header-bar").hide(), "1" != u && "on" != u && "disabled" != u && jQuery("#ast-fixed-header .ast-below-header").hide(), "1" != m && "on" != m && "disabled" != m && "1" != y && "on" != y && "disabled" != y && "1" != u && "on" != u && "disabled" != u || (t = _ ? {
            padding_top: "",
            padding_bottom: ""
            ...
            var t;
            jQuery("#ast-fixed-header .main-header-menu-toggle").hasClass("toggled") ? (t = jQuery(h).height(), "1" == f && jQuery("html").css({
                overflow: "auto"
